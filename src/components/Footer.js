        ...
        <div className="row mb-5">
          ...
          <div className="col-md">
            <div className="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul className="list-unstyled">
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Search Properties</a></li>
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>For Agents</a></li>
          ...
          <div className="col-md">
             <div className="ftco-footer-widget mb-4">
              ...
              <ul className="list-unstyled">
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>About Us</a></li>
